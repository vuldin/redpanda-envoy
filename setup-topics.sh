...
docker exec primary-broker-0 rpk topic create failover-demo-topic \
    --partitions 3 \
    --replicas 3 \
    --brokers primary-broker-0:9091,primary-broker-1:9091,primary-broker-2:9091
...
docker exec primary-broker-0 rpk topic list --brokers primary-broker-0:9091,primary-broker-1:9091,primary-broker-2:9091
